...
public class Canvas2 extends View {
     ...
     */
    public Canvas2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public Canvas2(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
